...
import 'package:screentwo/screens/login.dart';
import 'package:screentwo/screens/intro_page.dart';
        ...
        Stack(
            children: [
              Container(
               ...
               image:AssetImage('images/soup.jpg'), fit: BoxFit.cover),
               ),
              ),
              Container(
            ...
            children: [
              Container(
               decoration: BoxDecoration(
               image: DecorationImage(
               image:AssetImage('images/wafflesandwitch.jpg'), fit: BoxFit.cover),
               ),
              ),
              Container(
          ...
          Stack(
            children: [
              Container(
               decoration: BoxDecoration(
               image: DecorationImage(
               image:AssetImage('images/frenchtoast.jpg'), fit: BoxFit.cover),
               ),
              ),
              Container(
     ...
     Container(
           ...
           child:RaisedButton(
                  ...
                  child: Container(
                    ...
                    child: Text('Get Started!', style: TextStyle(fontSize: 20, fontFamily: 'SourceSansPro')),
                    decoration: BoxDecoration(
